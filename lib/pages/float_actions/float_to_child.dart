...
class floatactiontochild extends StatefulWidget {
  floatactiontochild({Key? key}) : super(key: key);

  @override
  _floatactiontochild createState() => _floatactiontochild();
}

class _floatactiontochild extends State<floatactiontochild> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          backgroundColor: Colors.red, title: Text("Float transfer to Child")),
      body: Padding(
